...
for Tk=200:4:long
    ...
    if Tk>changep_online
        ...
        lmada=ZKK1(1,Tk);
        sigma_B2=RR1(1,Tk);
%         Theta1=parameter1(3,2);
%         lmada=parameter1(3,1);
%         sigma_B2=parameter1(4,1)^2;
        for Lk=1:3000-Tk
            w1=(threshold-Xk);
            F1=w1;        
        ...
        for tau=Tk:1:1200
          for Lk=1:3000-Tk
            ...
            elseif Tk+Lk==tau
                ...
                lmada_1=ZKK1(1,Tk);
                sigma_B_1=RR1(1,Tk);
                miu_gamma=parameter1(6,1);
                sigma_gamma=parameter1(6,2);
                TT2=(tau-Tk)*dt;
...
pdf_wiener_r1=pdf_wiener;
save pdf_wiener_r1.mat pdf_wiener_r1