...
close all
load('parameter1.mat');
% threshold=4220.00;%bearing1-1 
threshold=6100.00;%bearing1-2
% threshold=2100.00;%bearing1-3 
% threshold=4600.00;%bearing2-2

i=1;
for Tk=30:1:long
    Xk=(Bearing1_feature(dataset,Tk));
    if Xk>=threshold
        break;
    end  
    ...
    elseif Tk<changep_online
        ...
        for tau=Tk:1:200
               for Lk=1:400-Tk
                ...
                elseif Tk+Lk>tau 
                    ...
                    lmada_1=ZKK1(1,Tk);
                    sigma_B_1=RR1(1,Tk);
                    Theta_2=parameter1(3,2);
                    lmada_2=parameter1(3,1);
                    sigma_B_2=parameter1(4,1)^2;
       ...
       pd=makedist('normal','mu',parameter1(5,1),'sigma',parameter1(5,2));
       trn = truncate(pd,Tk*dt,200);
       tau1=Tk*dt:1:200;
...
%% bearing1-1
% pdf_wiener_r1_1=pdf_wiener;
% save pdf_wiener_r1_1.mat  pdf_wiener_r1_1

%% bearing1-2
pdf_wiener_r2_1=pdf_wiener;
save pdf_wiener_r2_1.mat  pdf_wiener_r2_1

%% bearing1-3
% pdf_wiener_r3_1=pdf_wiener;
% save pdf_wiener_r3_1.mat  pdf_wiener_r3_1

%% bearing2-2
% pdf_wiener_r4_1=pdf_wiener;
% save pdf_wiener_r4_1.mat  pdf_wiener_r4_1